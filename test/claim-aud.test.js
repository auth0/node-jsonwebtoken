...
function verifyWithAudience(token, audience,  callback) {
  testUtils.verifyJWTHelper(token, 'secret', {audience, algorithms: ['HS256']}, callback);
}

describe('audience', () => {
  describe('`jwt.sign` "audience" option validation', () => {
    [
      true,
      false,
      null,
      ...
      it(`should error with with value ${util.inspect(audience)}`, (done) => {
    ...
    it('should error when "aud" is in payload', (done) => {
  ...
  describe('when signing and verifying a token with "audience" option', () => {
    describe('with a "aud" of "urn:foo" in payload', () => {
      let token;
      ...
      [
        ...
        it(`should verify and decode with verify "audience" option of ${util.inspect(audience)}`, (done) => {
      ...
      it(`should error on no match with a string verify "audience" option`, (done) => {
      ...
      it('should error on no match with an array of string verify "audience" option', (done) => {
      ...
      it('should error on no match with a Regex verify "audience" option', (done) => {
        verifyWithAudience(token, /^urn:no-match$/, (err) => {
          testUtils.asyncCheck(done, () => {
            expect(err).toBeInstanceOf(jwt.JsonWebTokenError);
            expect(err).toHaveProperty('message', `jwt audience invalid. expected: /^urn:no-match$/`);
      ...
      it('should error on no match with an array of Regex verify "audience" option', (done) => {
        verifyWithAudience(token, [/^urn:no-match-1$/, /^urn:no-match-2$/], (err) => {
          testUtils.asyncCheck(done, () => {
            expect(err).toBeInstanceOf(jwt.JsonWebTokenError);
            expect(err).toHaveProperty(
      ...
      it('should error on no match with an array of a Regex and a string in verify "audience" option', (done) => {
    ...
    describe('with an array of ["urn:foo", "urn:bar"] for "aud" value in payload', () => {
      let token;
      ...
      [
        ...
        it(`should verify and decode with verify "audience" option of ${util.inspect(audience)}`, (done) => {
          verifyWithAudience(token, audience, (err, decoded) => {
            testUtils.asyncCheck(done, () => {
              expect(err).toBeNull();
              expect(decoded.aud).toEqual(['urn:foo', 'urn:bar']);
            });
          });
        });
      });
      ...
      describe('when checking for a matching on both "urn:foo" and "urn:bar"', () => {
        it('should verify with an array of stings verify "audience" option', (done) => {
        ...
        it('should verify with a Regex verify "audience" option', (done) => {
        ...
        it('should verify with an array of Regex verify "audience" option', (done) => {
      ...
      describe('when checking for a matching for "urn:foo"', () => {
        it('should verify with a string verify "audience"', (done) => {
        ...
        it('should verify with an array of Regex verify "audience"', (done) => {
        ...
        it('should verify with an array containing a string and a Regex verify "audience" option', (done) => {
        ...
        it('should verify with an array containing a Regex and a string verify "audience" option', (done) => {
      ...
      describe('when checking matching for "urn:bar"', () => {
        it('should verify with a string verify "audience"', (done) => {
    ...
    describe('without a "aud" value in payload', () => {
      let token;
      ...
      it('should verify and decode without verify "audience" option', (done) => {
